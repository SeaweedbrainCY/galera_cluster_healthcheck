...
try:
    ...
    ERROR_THRESHOLD = int(os.environ['ERROR_THRESHOLD']) if 'ERROR_THRESHOLD' in os.environ else 10800 #3h in seconds
...
def can_fire_alert(is_error):
    ...
    return ((current_date - last_notif_date).seconds > ERROR_THRESHOLD and is_error) or was_last_notif_error != is_error 
